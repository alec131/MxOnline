...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, choices=(('pxjg', u'培训机构 '), ('gx', u'高校'), ('gr', u'个人')), verbose_name=u'机构类别', default = u'培训机构')
...
class Teacher(models.Model):
    ...
    click_nums = models.IntegerField(default=0, verbose_name=u"点击数")
    fav_nums = models.IntegerField(default=0, verbose_name=u"收藏数")
    image = models.ImageField(default='', upload_to="org/%Y/%m", verbose_name=u"头像", max_length=100)
